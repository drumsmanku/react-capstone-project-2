...
function CategoriesPage(props) {
  ...
  const removeButton = (event, buttonText) => {
    ...
    const categoryItems = JSON.stringify(additionalButtons);
    localStorage.setItem('categoryItems', categoryItems);
  };
  ...
  useEffect(() => {
    ...
    localStorage.setItem('categoryItems', categoryItems);
    console.log(localStorage.getItem('categoryItems'));
  }, [additionalButtons]);
    ...
    <div className="container">
      ...
      <div className="second-container">
        <div className="category-container">
          ...
          <button onClick={routeFunc} style={{backgroundColor:'#148A08', borderRadius:'1.5rem', border:'none', width:'9rem',height:'2.5rem',color:'white', fontSize:'1.2rem', letterSpacing:'0.1rem', fontFamily:'DM Sans', zIndex:999, position:'absolute', right:'1rem', marginTop:'1rem'}}>Next</button>
        </div>
