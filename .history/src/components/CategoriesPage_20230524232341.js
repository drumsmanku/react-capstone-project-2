    ...
    <div className='container'>
      <div className='first-container'>
        <div className="first-first-container">
          ...
          <div style={{width:'70%'}}>
            <button style={{display:'none'}}>hey2</button>
            <button style={{display:'none'}} >hey3</button>
            <button style={{display:'none'}}>hey4</button>
            <button style={{display:'none'}}>hey5</button>
            <button style={{display:'none'}}>hey6</button>
            <button style={{display:'none'}}>hey7</button>
            <button style={{display:'none'}}>hey8</button>
            <button style={{display:'none'}}>hey9</button>
          </div>
      ...
      <div className='second-container'>
        <div className='category-container'>
          {categories.map((category, index)=>(
            <button onClick={handleButtonState} style={{border:'none', background:'none',color:'white', backgroundColor:backgroundcolor[index], height:'10rem', width:'10rem', margin:'0.6rem', borderRadius:'1rem', fontSize:'1.7rem', fontFamily:'DM Sans', textAlign:'left',verticalAlign:'top',paddingTop:0, buttonStyle}} key={index}>{category} <img src={imgs[index]} alt="not found" width={140} style={{marginLeft:'0.3rem', marginTop:'1rem'}} /></button>
          ))}
