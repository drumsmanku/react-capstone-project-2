...
function WeatherandNews() {
  ...
  return (
    <div className="main-container-w ">
      ...
      : 'none', backgroundRepeat:'no-repeat', backgroundSize:'30rem', display:'flex', flexDirection:'column',justifyContent:'flex-end'}}>
          {newsData && newsData.articles && newsData.articles.length > 0 ? (
            <div className="news-item">
              ...
              <p>{newsData.articles[currentNewsIndex].urlAt}</p>
