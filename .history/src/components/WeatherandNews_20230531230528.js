          ...
          <div className="rest-stopwatch">
            <div className="timers">
              <div className="hours" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 <p style={{color:'white', fontFamily:'DM Sans'}}>Hours</p>
                 <img src={up} alt="" width={20} onClick={()=>{console.log('hwy')}} />
                 <textarea style={{border:'none', backgroundColor:'#1E2343', outline:'none', resize:'none', textAlign:'center', fontSize:'2.2rem', color:'white', fontFamily:'DM Sans', display:'flex',alignItems:'center' }} name="hourtext" id="hourtext" cols="2" rows="2"></textarea>
                 <img src={down} alt="" width={20} onClick={()=>{console.log('hwy')}} />
              </div>
