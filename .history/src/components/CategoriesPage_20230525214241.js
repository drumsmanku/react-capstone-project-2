...
function CategoriesPage(props) {
  ...
  const handleButtonState=(event)=>{
    ...
    event.target.style.border = active? 'none' : '2px solid red';
  }
  const buttonStyle={
    ...
    <div className='container'>
      <div className='first-container'>
        <div className="first-first-container">
          ...
          <div style={{width:'70%'}}>
            <button style={{}}>hey2</button>
            <button style={{}} >hey3</button>
            <button style={{}}>hey4</button>
            <button style={{}}>hey5</button>
            <button style={{}}>hey6</button>
            <button style={{}}>hey7</button>
            <button style={{}}>hey8</button>
            <button style={{}}>hey9</button>
          </div>
