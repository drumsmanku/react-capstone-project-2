...
function WeatherandNews() {
  ...
  const upButtonClickMinutes=()=>{
    ...
    setMinuteTimerInput(minuteInput);
  }
  ...
  const upButtonClickSeconds=()=>{
    ...
    setSecondsTimerInput(secondsInput);
  }
      ...
      <div className="first-container-w">
        ...
        <div className="stopwatch">
          <div className="stop-icon">
            <h1 style={{fontFamily:'DM Sans', letterSpacing:'0.2rem', color:'white'}}>{hoursTimerInput}:{minuteTimerInput}:{secondsTimerInput}</h1>
          </div>
          <div className="rest-stopwatch">
            <div className="timers">
              <div className="hours" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 <p style={{color:'#949494', fontFamily:'DM Sans', fontSize:'1.3rem'}}>Hours</p>
                 <img src={up} alt="" width={20} onClick={upButtonClickHours} />
                 <input type="text" value={hoursInput} style={{width:'2.4rem',height:'3.5rem', background:'none', border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'2rem', color:'white', paddingLeft:'1rem'}} />
                 <img src={down} alt="" width={20} onClick={downButtonClickHours} />
              </div>
              <div className="hminutes" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 <p style={{color:'#949494', fontFamily:'DM Sans', fontSize:'1.3rem'}}>Minutes</p>
                 <img src={up} alt="" width={20} onClick={upButtonClickMinutes} />
                 <input type="text" value={minuteInput} style={{width:'2.4rem',height:'3.5rem', background:'none', border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'2rem', color:'white',paddingLeft:'1rem'}} />
                 <img src={down} alt="" width={20} onClick={downButtonClickMinutes} />
              </div>
              <div className="seconds" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 <p style={{color:'#949494', fontFamily:'DM Sans', fontSize:'1.3rem'}}>Seconds</p>
                 <img src={up} alt="" width={20} onClick={upButtonClickSeconds} />
                 <input type="text" value={secondsInput} style={{width:'2.4rem',height:'3.5rem', background:'none', border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'2rem', color:'white',paddingLeft:'1rem'}} />
                 <img src={down} alt="" width={20} onClick={downButtonClickSeconds} />
              </div>
              
            </div>
            <div className="start-button">
              <button id="start-button1" onClick={startTimer}>Start</button>
            </div>
          </div>
        </div>
      </div>
