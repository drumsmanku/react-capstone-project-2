    ...
    <div className="main-container-w ">
      <div className="first-container-w">
        ...
        <div className="weather-card-w" style={{color:'white', display:'flex', flexDirection:'column'}}>
          <div style={{display:'flex', fontFamily:'DM Sans', fontSize:'1.8rem', justifyContent:'space-around', fontWeight:'600', height:'4rem', alignItems:'center' , backgroundColor:'#FF4ADE', borderTopLeftRadius:'2rem', borderTopRightRadius:'2rem', letterSpacing:'0.1rem', overflow:'auto'}}>
            ...
            {weatherData && (
              <>
                ...
                <div style={{display:'flex', flexDirection:'column', height:'inherit',alignItems:'center', justifyContent:'space-around', marginTop:'2rem'}}>
                  ...
                  <div style={{display:'flex', width:'8rem', justifyContent:'space-between', marginLeft:'1rem'}}>
                ...
                <div style={{display:'flex', flexDirection:'column', height:'inherit',alignItems:'center', justifyContent:'space-around', marginTop:'2rem'}}>
                  <div style={{display:'flex', width:'10rem', justifyContent:'space-between', marginLeft:'1rem'}}>
                    <img src={img3} alt="not found" />
                    <p style={{margin:'0', maxWidth:'6rem'}}>{weatherData.current.wind_kph} Km/h Wind</p>
                  </div>
                  <div style={{display:'flex', width:'10rem', justifyContent:'space-between', marginLeft:'1rem'}}>
                    <img src={img4} alt="not found" />
                    <p style={{margin:'0', maxWidth:'6rem'}}>{weatherData.current.humidity}% Humidity</p>
                  </div>
                </div>
