      ...
      : 'none', backgroundRepeat:'no-repeat', backgroundSize:'40rem', display:'flex', flexDirection:'column',justifyContent:'flex-end'}}>
          {newsData && newsData.articles && newsData.articles.length > 0 ? (
            <div className="news-item">
              <div style={{height:'9rem', backgroundColor:'rgba(0, 0, 0, 0.74)', display:'flex', flexDirection:'column',alignItems:'center', justifyContent:'center' }}> 
               <p style={{color:'white', fontFamily:'DM Sans', fontSize:'1.1rem', fontWeight:'bold', width:'10rem'}}>{newsData.articles[currentNewsIndex].title}</p>
