          ...
          <div className="rest-stopwatch">
            <div className="timers">
              <div className="hours" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 ...
                 <textarea style={{border:'none', backgroundColor:'#1E2343', outline:'none', resize:'none', textAlign:'center', fontSize:'2.2rem', color:'white' }} name="hourtext" id="hourtext" cols="2" rows="2"></textarea>
