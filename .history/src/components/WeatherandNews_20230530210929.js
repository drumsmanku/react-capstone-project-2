  ...
  return (
    <div className="main-container-w ">
        ...
        <div className="details-card-w">
          ...
          >
            <div>
              ...
              {myData && <h1 style={{ margin: "1rem", fontSize:'1.2rem' }}>{myData.UserName}</h1>}
            </div>

            <div
              className="cats-w"
              style={{ marginTop: "1rem", maxHeight: "100px", width:'13rem' }}
            >
              {catData &&
            ...
            {weatherData && (
              <>
                ...
                >
                  ...
                  <p
                    style={{ margin: "0", fontSize: "0.8rem", width: "6rem" }}
                  >
                ...
                >
                  <p
                    style={{ margin: "0", fontSize: "1.5rem", fontWeight: "400" }}
                  >
                  ...
                  >
                    ...
                    <p style={{ margin: "0", maxWidth: "6rem", fontSize:'0.8rem' }}>
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ margin: "0", maxWidth: "4rem", fontSize:'0.8rem' }}>
      ...
      <div className="second-container-w">
        <div className="news-card-w" style={{backgroundImage: newsData && newsData.articles && newsData.articles.length > 0 && newsData.articles[currentNewsIndex].urlToImage
      ? `url(${newsData.articles[currentNewsIndex].urlToImage})`
      : 'none', backgroundRepeat:'no-repeat', backgroundSize:'40rem', display:'flex', flexDirection:'column',justifyContent:'flex-end'}}>
          {newsData && newsData.articles && newsData.articles.length > 0 ? (
            <div className="news-item" style={{}}>
              <div style={{height:'9rem', backgroundColor:'rgba(0, 0, 0, 0.74)', display:'flex', flexDirection:'column',alignItems:'flex-start', justifyContent:'center',textAlign:'left', paddingLeft:'2rem' }}> 
               <p style={{color:'white', fontFamily:'DM Sans', fontSize:'1.1rem', fontWeight:'bold', width:'20rem'}}>{newsData.articles[currentNewsIndex].title}</p>
               <div style={{color:'white', fontFamily:'DM Sans', fontSize:'0.8rem', letterSpacing:'0.2rem'}}>
                 {month}-{day}-{currentDateTime.getFullYear()} | {currentDateTime.getHours()}:{currentDateTime.getMinutes()} PM
               </div>
              </div>
              <div style={{height:'18.5rem', width:'20rem', color:'black', fontFamily:'DM Sans', fontSize:'1rem', marginLeft:'4rem'}}>
