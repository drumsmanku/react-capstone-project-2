    ...
    <div className="main-container-w ">
      <div className="first-container-w">
        ...
        <div className="weather-card-w" style={{color:'white', display:'flex', flexDirection:'column'}}>
          <div style={{display:'flex', fontFamily:'DM Sans', fontSize:'1.8rem', justifyContent:'space-around', fontWeight:'600', height:'4rem', alignItems:'center' , backgroundColor:'white'}}>
