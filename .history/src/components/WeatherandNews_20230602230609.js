...
function WeatherandNews() {
  ...
  const fetchWeatherData = async () => {
    ...
    const apiKey = '5M5TNJNMM4CQ46DLATYJJR6UB';
    const apiUrl = `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/weatherdata/forecast?aggregateHours=24&combinationMethod=aggregate&contentType=json&unitGroup=metric&locationMode=single&key=${apiKey}&dataElements=default&locations=${location}`;
          ...
          <div className="cards-container-w">
            <div className="details-card-w">
              ...
              >
                <div>
                  {myData && (
                    <p style={{ fontSize: "0.8rem", margin: "0.4rem" }}>
                      {myData.Name}
                    </p>
                  )}
                  {myData && (
                  ...
                  {myData && (
                    <h1 style={{ margin: "0.4rem", fontSize: "1.2rem" }}>
                      {myData.UserName}
                    </h1>
                  )}
                </div>
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {weatherData.sealevelpressure} mbar Pressure
                        </p>
                      </div>
                    </div>
                    <div
