          ...
          <div className="rest-stopwatch">
            <div className="timers">
              <div className="hours" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 ...
                 <input type="text" value={hoursInput} style={{width:'2.4rem',height:'3.5rem', background:'none', border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'2rem', color:'white'}} />
