  ...
  return (
    <div className="reg-page">
      ...
      <div className="second-div">
        ...
        <form action="" onSubmit={handleChange} style={{color:'white'}}>
          <input type="text" placeholder='Name' name='Name' style={{color:'white', paddingLeft:'1rem', fontSize:'1.2rem'}} value={formData.Name} required onChange={setTheData} />
          <input type="text" placeholder='UserName' name='UserName' style={{color:'white', paddingLeft:'1rem', fontSize:'1.2rem'}} value={formData.UserName} required onChange={setTheData} />
          <input type="email" name="Email" id="mail" placeholder='Email' value={formData.Email} style={{color:'white', paddingLeft:'1rem', fontSize:'1.2rem'}} required onChange={setTheData}/>
          <input type="number" name="Number" id="number" placeholder='Mobile' value={formData.Number} style={{color:'white', paddingLeft:'1rem', fontSize:'1.2rem'}} required onChange={setTheData}/>
