          ...
          <div className="rest-w" style={{width:'50%', color:'white', fontFamily:'DM Sans'}}>
            ...
            <div className="cats-w">
              {catData&& catData.map((cat,index)=>(
                <button style={{backgroundColor:'#9F94FF', border:'none', borderRadius:'2rem', width:'9rem', height:'2.5rem',fontSize:'1.2rem', color:'white', textAlign:'left'}} key={index}>{cat}</button>
              ))}
