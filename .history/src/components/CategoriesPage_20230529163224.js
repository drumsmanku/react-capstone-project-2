    ...
    <div className="container">
      ...
      <div className="second-container">
        <div className="category-container">
          ...
          <button onClick={routeFunc} style={{backgroundColor:'#148A08', borderRadius:'1.5rem', border:'none', width:'9rem',height:'2.5rem',color:'white', fontSize:'1.2rem', letterSpacing:'0.1rem', fontFamily:'DM Sans', zIndex:999, position:'absolute', right:'5rem', marginTop:'1rem'}}>Next</button>
        </div>
