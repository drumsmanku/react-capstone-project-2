    ...
    <div className="container">
      ...
      <div className="second-container">
        ...
        <div style={{ display: "flex"}}>
          <button onClick={()=>navigate('/success')} style={{backgroundColor:'#148A08', borderRadius:'1.5rem', border:'none', width:'9rem',height:'2.5rem',color:'white', fontSize:'1.2rem', letterSpacing:'0.1rem', fontFamily:'DM Sans'}}>Next</button>
        </div>
      </div>
    </div>
  );
