    ...
    <div className="main-container-w ">
      <div className="first-container-w">
        <div className="details-card-w">
          ...
          <div className="rest-w" style={{width:'50%',display:'flex',flexDirection:'column', color:'white', fontFamily:'DM Sans',flexWrap:'wrap', overflowY:'scroll'}}>
            <div>
            ...
            <div className="cats-w" style={{marginTop:'1rem'}}>
