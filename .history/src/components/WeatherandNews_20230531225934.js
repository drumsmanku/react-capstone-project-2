          ...
          <div className="rest-stopwatch">
            <div className="timers">
              <div className="hours" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 ...
                 <textarea style={{border:'none', backgroundColor:'#1E2343', outline:'none', resize:'none', textAlign:'center', fontSize:'2rem' }} name="hourtext" id="hourtext" cols="4" rows="4"></textarea>
