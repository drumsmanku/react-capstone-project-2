        ...
        <div className="stopwatch">
          ...
          <div className="rest-stopwatch">
            <div className="timers">
              <div className="hours" style={{display:'flex', flexDirection:'column'}}>
                 <p>Hours</p>
                 <button  style={{ backgroundImage: `url(${up})`, backgroundColor:'none', height:'50px', width:'50px', border:'none' ,backgroundSize:'cover', backgroundRepeat:'no-repeat' }}></button>
                 <p></p>
                 <button></button>
              </div>
