          ...
          <div className="rest-stopwatch">
            <div className="timers">
              ...
              <div className="hminutes" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 ...
                 <input type="text" value={minuteInput} style={{width:'2.4rem',height:'3.5rem', background:'none', border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'2rem', color:'white'}} />
              ...
              <div className="seconds" style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                 ...
                 <input type="text" value={secondsInput} style={{width:'2.4rem',height:'3.5rem', background:'none', border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'2rem', color:'white'}} />
